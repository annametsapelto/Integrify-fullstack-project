        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    role = table.Column<User.UserRole>(type: "role", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sub_genre_id = table.Column<int>(type: "integer", nullable: true),
                    publisher = table.Column<string>(type: "text", nullable: true),
                    publishing_year = table.Column<int>(type: "integer", nullable: false),
                    page_count = table.Column<int>(type: "integer", nullable: false),
                    price = table.Column<decimal>(type: "numeric", nullable: false),
                    storage_total = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_books_genres_sub_genre_id",
                        column: x => x.sub_genre_id,
                        principalTable: "genres",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_books_orders_order_id",
                        column: x => x.order_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_book_order", x => x.id);
                    table.ForeignKey(
                        name: "fk_book_order_books_book_id",
                        column: x => x.book_id,
                        principalTable: "books",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_book_order_orders_order_id",
                        column: x => x.order_id,
                        principalTable: "orders",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_book_order_book_id",
                table: "book_order",
                column: "book_id");

            migrationBuilder.CreateIndex(
                name: "ix_book_order_order_id",
                table: "book_order",
                column: "order_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_books_order_id",
                table: "books",
                column: "order_id");

            migrationBuilder.CreateIndex(
                name: "ix_books_sub_genre_id",
                table: "books",
                column: "sub_genre_id");
